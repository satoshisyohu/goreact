...
func (c Revel_JWT_MySQL) List() revel.Result {
    ...
    for _, r := range revel_jwt_mysql {
        if (r.Revel_JWT_MySQL_Id == res.Revel_JWT_MySQL_Id) {
            ...
            switch choose_parameter{
                ...
                case "GET_ALL":
                    ...
                    if err != nil {
                        ...
                        return c.GetRevelJWTMySQLAllMethod(length)
                    }
                case "GET_JWT":
                ...
                case "POST":
                    return c.RegistRevelJWTMySQLMethod(res)
                case "DELETE":
                    return c.DeleteRevelJWTMySQLMethod(res.Revel_JWT_MySQL_Id)
                case "UPDATE" :
                    for _, k := range keys {
                        if _, ok := c.Params.Query[k]; ok {
                            revel.TRACE.Printf("Param OK")
                            no_key = false
                            return c.UpdateRevelJWTMySQLMethod(k, c.Params.Query[k][0], res.Revel_JWT_MySQL_Id, res.Date)
                        }
                    }
                    if no_key {
                        revel.ERROR.Printf("No settings %#v", val)
...
func (c Revel_JWT_MySQL) RegistRevelJWTMySQL() revel.Result {
    var res models.Revel_JWT_MySQL
    c.Params.Bind(&res.Revel_JWT_MySQL_Id, "Id")
    c.Params.Bind(&res.Title, "Title")
    c.Params.Bind(&res.Date, "Date")
...
func (c Revel_JWT_MySQL) RegistRevelJWTMySQLMethod(res models.Revel_JWT_MySQL) revel.Result {
...
func (c Revel_JWT_MySQL) DeleteRevelJWTMySQL() revel.Result {
    var res models.Revel_JWT_MySQL
    c.Params.Bind(&res.Revel_JWT_MySQL_Id, "Id")
...
func (c Revel_JWT_MySQL) DeleteRevelJWTMySQLMethod(robohonId int) revel.Result {
...
func (c Revel_JWT_MySQL) UpdateRevelJWTMySQL() revel.Result {
    var res models.Revel_JWT_MySQL
    c.Params.Bind(&res.Revel_JWT_MySQL_Id, "Id")
    c.Params.Bind(&res.Title, "Title")
    c.Params.Bind(&res.Date, "Date")
...
func (c Revel_JWT_MySQL) UpdateRevelJWTMySQLMethod(key string, value string, robohonId int, date string) revel.Result {
    ...
    show_char := "UpdateRevelJWTMySQL " + value
    r := Response{show_char}
    return c.RenderJson(r)
}
...
func (c Revel_JWT_MySQL) GetRevelJWTMySQLAllMethod (length int) revel.Result {
